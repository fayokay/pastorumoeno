...
Route::group(['middleware' => 'setlang'], function () {
  ...
  Route::post('/getWard', 'Front\FrontendController@fetchWard'); 
  Route::post('/getWard2', 'Front\FrontendController@fetchWard2');    
  Route::post('/getPU', 'Front\FrontendController@fetchPU');    
  Route::post('/getPVC', 'Front\FrontendController@fetchPVC'); 
  Route::post('/getPVC', 'Front\FrontendController@fetchPVC2')->name('pvc-list');

  //volunteer form
  Route::get('/volunteer/form', 'Front\FrontendController@volunteerform')->name('front.volunteerform');
  ...
  Route::get('/supporters', 'Front\FrontendController@quote')->name('front.supporters');
  Route::post('/sendquote', 'Front\FrontendController@sendquote')->name('front.sendquote');
  Route::post('/sendsupport', 'Front\FrontendController@sendsupport')->name('front.sendsupport');
...
Route::group(['middleware' => ['web', 'setlang']], function () {
  ...
  Route::get('/register/manual', 'User\RegisterController@registerList')->name('user-register-list');
...
Route::group(['prefix' => 'user', 'middleware' => ['auth', 'userstatus', 'setlang']], function () {
  ...
  Route::get('/supporters', 'User\SupportersController@index')->name('user-supporters');
...
Route::group(['prefix' => 'admin', 'middleware' => 'guest:admin'], function () {
  ...
  Route::post('/sendmail', 'Admin\ForgetController@sendmail')->name('admin.forget.mail');
    ...
    Route::get('/generateunit', 'Admin\StatisticalController@index')->name('admin.statistics.index');
    Route::get('/getdata/{type}', 'Admin\StatisticalController@getIncrease')->name('admin.statistics.getIncrease');
    Route::get('/getdata/{type}/{id}', 'Admin\StatisticalController@getIncrease')->name('admin.statistics.getIncreaseWard');
    Route::get('/getdata/{type}/{id}/{unit}', 'Admin\StatisticalController@getIncrease')->name('admin.statistics.getIncreaseUnit');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin', 'checkstatus', 'setLfmPath']], function () {
  ...
  Route::group(['middleware' => 'checkpermission:Content Management'], function () {
        ...
        // Admin Hero Section (Carousel Version) Routes
        Route::get('/herosection/carousels', 'Admin\CarouselController@index')->name('admin.carousel.index');
        Route::post('/herosection/carousel/store', 'Admin\CarouselController@store')->name('admin.carousel.store');
        Route::get('/herosection/carousel/{id}/edit', 'Admin\CarouselController@edit')->name('admin.carousel.edit');
        Route::post('/herosection/carousel/update', 'Admin\CarouselController@update')->name('admin.carousel.update');
        Route::post('/herosection/carousel/delete', 'Admin\CarouselController@delete')->name('admin.carousel.delete');



        // Admin Hero Section (Flipper Version) Routes
        Route::get('/herosection/flippers', 'Admin\FlipperController@index')->name('admin.flipper.index');
        Route::post('/herosection/flipper/store', 'Admin\FlipperController@store')->name('admin.flipper.store');
        Route::get('/herosection/flipper/{id}/edit', 'Admin\FlipperController@edit')->name('admin.flipper.edit');
        Route::post('/herosection/flipper/update', 'Admin\FlipperController@update')->name('admin.flipper.update');
        Route::post('/herosection/flipper/delete', 'Admin\FlipperController@delete')->name('admin.flipper.delete');
        ...
        Route::post('/feature/{langid}/update', 'Admin\FeatureController@updateSection')->name('admin.featuresection.update');
      ...
      // Admin About Section Routes
        Route::get('/aboutsection', 'Admin\AboutsectionController@index')->name('admin.aboutsection.index');
        Route::post('/aboutsection/{langid}/update', 'Admin\AboutsectionController@update')->name('admin.aboutsection.update');
...
Route::group(['middleware' => ['setlang']], function () {
  ...
  foreach ($wdPermalinks as $pl) {
    ...
    if ($type == 'packages') {
      ...
      $action = 'Front\FrontendController@aboutus';
      $routeName = 'front.aboutus';
    } elseif ($type == 'meetprofile') {
      $action = 'Front\FrontendController@meetprofile';
      $routeName = 'front.meetprofile';
