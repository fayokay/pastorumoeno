                        ...
                        <div class="card border-primary mb-3">
                            ...
                            <div class="card-body">
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">{{__('About')}} <a data-text="{{__('About')}}" data-type="aboutus" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>

                                    <li class="list-group-item">{{__('Meet Profile')}} <a data-text="{{__('Meet Profile')}}" data-type="meetprofile" class="addToMenus btn btn-primary btn-sm float-right" href="">Add to Menus</a></li>
