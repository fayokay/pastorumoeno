            ...
            <div class="card-body pt-5 pb-5">
                <div class="row">
                    ...
                    <form id="ajaxForm" class="" action="{{route('admin.slider.update')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control jscolor" name="title_color" value="{{$slider->title_color}}">
                                    <p id="errtitle_text_color" class="em text-danger mb-0"></p>
                                </div>
                            </div>
                        </div>


                        @if ($be->theme_version == 'gym' || $be->theme_version == 'car' || $be->theme_version == 'cleaning' || $be->theme_version == 'politics')
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                       ...
                       <!--  @if ($be->theme_version == 'cleaning' || $be->theme_version == 'politics')
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control jscolor" name="text_color" value="{{$slider->text_color}}">
                                    <p id="errtext_color" class="em text-danger mb-0"></p>
                                </div>
                            </div>
                        </div>
                        @endif
