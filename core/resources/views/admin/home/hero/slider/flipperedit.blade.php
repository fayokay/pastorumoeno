...
<div class="page-header">
    <h4 class="page-title">Edit Flipper</h4>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="card-title d-inline-block">Edit Flipper</div>
                <a class="btn btn-info btn-sm float-right d-inline-block" href="{{route('admin.flipper.index') . '?language=' . request()->input('language')}}">
            ...
            <div class="card-body pt-5 pb-5">
                <div class="row">
                    ...
                    <form id="ajaxForm" class="" action="{{route('admin.flipper.update')}}" method="post">
                        @csrf
