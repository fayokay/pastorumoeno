                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control jscolor" name="title_color" value="#13287e">
                            <p id="errtitle_color" class="em text-danger mb-0"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control jscolor" name="text_color" value="#13287e">
