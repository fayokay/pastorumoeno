      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
              ...
              <form id="ajaxForm" action="{{route('admin.featuresection.update', $lang_id)}}" method="post">
          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input name="feature_section_title" class="form-control" value="{{$abs->feature_section_title}}">
                  <p id="errfeature_section_title" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Subtitle **</label>
                  <input name="feature_section_subtitle" class="form-control" value="{{$abs->feature_section_subtitle}}">
                  <p id="errfeature_section_subtitle" class="em text-danger mb-0"></p>
                </div>
                <div class="form-group">
                  <label for="">Subtitle **</label>
                  <input name="feature_section_url" class="form-control" value="{{$abs->feature_section_url}}">
                  <p id="errfeature_section_subtitle" class="em text-danger mb-0"></p>
                </div>
                    ...
                    <tbody>
                      @foreach ($features as $key => $feature)
                        <tr>
                          ...
                          <td>{{convertUtf8($feature->description)}}</td>
