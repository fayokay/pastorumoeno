            ...
            <div class="card card-stats card-danger card-round">
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="col-9 col-stats pl-1">
                            <div class="numbers">
                                <p class="card-category">Supporters Requests</p>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-head-row">
                            <h4 class="card-title">Recent Supporters</h4>
                        </div>
                        <p class="card-category">
                            Top 10 latest supporters registration
                        </p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                @if (count($quotes) == 0)
                                <h3 class="text-center">NO SUPPORTER REQUEST FOUND</h3>
                                @else
