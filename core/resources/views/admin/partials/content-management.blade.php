...
@elseif(request()->path() == 'admin/aboutsection') active
...
@elseif(request()->path() == 'admin/herosection/carousels') active
@elseif(request()->is('admin/herosection/carousel/*/edit')) active
@elseif(request()->path() == 'admin/herosection/flippers') active
@elseif(request()->is('admin/herosection/flipper/*/edit')) active
...
@endif">
    ...
    @elseif(request()->path() == 'admin/aboutsection') show
    ...
    @elseif(request()->path() == 'admin/herosection/carousels') show
    @elseif(request()->is('admin/herosection/carousel/*/edit')) show
    @elseif(request()->path() == 'admin/herosection/flippers') show
    @elseif(request()->is('admin/herosection/flipper/*/edit')) show
    ...
    <li class="
            ...
            @elseif(request()->path() == 'admin/aboutsection') selected
            ...
            @elseif(request()->path() == 'admin/herosection/carousels') selected
            @elseif(request()->is('admin/herosection/carousel/*/edit')) selected
            @elseif(request()->path() == 'admin/herosection/flippers') selected
            @elseif(request()->is('admin/herosection/flipper/*/edit')) selected
            ...
            @endif">
                ...
                @endif" id="home">
                    <ul class="nav nav-collapse subnav">
                        ...
                        <li class="
                            @if(request()->path() == 'admin/herosection/carousels') active
                            @elseif(request()->is('admin/herosection/carousel/*/edit')) active
                            @endif">
                            <a href="{{route('admin.carousel.index') . '?language=' . $default->code}}">
                                <span class="sub-item">Carousel Version</span>
                            </a>
                        </li>
                        <li class="
                            @if(request()->path() == 'admin/herosection/flippers') active
                            @elseif(request()->is('admin/herosection/flipper/*/edit')) active
                            @endif">
                            <a href="{{route('admin.flipper.index') . '?language=' . $default->code}}">
                                <span class="sub-item">Flippers Version</span>
                            </a>
                        </li>
                    ...
                    <li class="@if(request()->path() == 'admin/introsection') active @endif">
                     ...
                     <li class="@if(request()->path() == 'admin/aboutsection') active @endif">
                        <a href="{{route('admin.aboutsection.index') . '?language=' . $default->code}}">
