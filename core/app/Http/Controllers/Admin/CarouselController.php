...
class CarouselController extends Controller
{
    public function index(Request $request)
    {
        ...
        $lang_id = $lang->id;
        $data['sliders'] = Carousel::where('language_id', $lang_id)->orderBy('id', 'DESC')->get();

        $data['lang_id'] = $lang_id;
        return view('admin.home.hero.slider.carousel', $data);
    }

    public function edit($id)
    {
        $data['slider'] = Carousel::findOrFail($id);
        return view('admin.home.hero.slider.carouseledit', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        $slider = Carousel::findOrFail($request->slider_id);
