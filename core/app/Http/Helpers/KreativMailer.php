...
class KreativMailer {
    ...
    public function mailFromAdmin($data) {
        ...
        if (array_key_exists('customer_id', $data)) {
            $body = preg_replace("/{customer_id}/", $data['customer_id'], $body);
        }
        if (array_key_exists('customer_password', $data)) {
            $body = preg_replace("/{customer_password}/", $data['customer_password'], $body);
        }
